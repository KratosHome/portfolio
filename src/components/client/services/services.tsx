  ...
  return (
    <section aria-label="services" id="services">
      <div className="relative mx-auto -mt-[700px] mb-[140px] max-w-[1442px] px-[24px]">
        ...
        <h2
          ref={titleRef}
          className="services-title hidden text-[40px] font-light uppercase lg:ml-[90px] lg:block lg:text-[96px]"
        >
          {t('services')}
        </h2>
        <div className="absolute -left-[155px] top-[-100px] size-[345px] rounded-full border-r-[1px] border-stone-500/30" />
        {/* eslint-disable-next-line */}
        <div className="bg-orbit-services-light dark:bg-orbit-services absolute -bottom-[120px] right-[15px] -z-20 h-[103px] w-[125px] dark:opacity-[0.7]" />
